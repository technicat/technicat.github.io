...
Various little [Fugu Games](fugugames) (check out these old [logos](logos)) and playing around with tools, like calculating [pi](processing-pi) in [Processing](http://processing.org/), writing [Ask an Asian American](aaaa) in [Ink](https://www.inklestudios.com/ink/), [learning](http://github.com/technicat/learngodot) [Godot](http://godotengine.org/), and [scripting](http://github.com/technicat/schemish) in [Scheme](https://www.staging.scheme.org/).
